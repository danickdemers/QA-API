...
class NoLonersReservationStrategyTest {
    private static final String A_RESERVATION_NAME = "Lonely boy";
    private static final int A_RESERVATION_SIZE = 6;
    private Seat seat1;
    private Seat seat2;
    private Seat seat3;
    private Seat seat4;
    ...
    private Seat seat8;
    private Seat seat9;
    private NoLonersReservationStrategy strategy;
    ...
    @BeforeEach
    void setup() {
        strategy = new NoLonersReservationStrategy();
        initialiseSeats();
        initialiseCubes();
    ...
    @Test
    void givenShopWithSomeFreeSeats_whenReserveSomeSeats_thenReserveRightSeatsWithNoLoner() {
    ...
    void givenShopWithoutFreeSeats_whenReserveSomeSeats_thenThrowInsufficientSeatsException() {
        ...
        when(thirdCube.getAvailableSeats()).thenReturn(List.of());
